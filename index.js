...
var questionQ1Array=[
    {
        ...
        questions: [
            {
                type:"html",
                html:"<audio src=\"2.mp3\" autoplay></audio><b><u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u>: ここには三つの<u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u>があります。</b>",
            },
            {
                type: "radiogroup",
                title:"请选择中文意思",
                name: "団体",
                choices: [
                    "小组", "案例", "把相反的两个事物当作一个整体来看的方法", "类型", "等级"
                ],
                correctAnswer: "小组"
            }
        ]
    },
    {
        questions: [
            {
                type:"html",
                html:"<audio src=\"1.mp3\" autoplay></audio><b><u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u>: これは一種の<u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u>だ。</b>",
            },
            {
                type: "radiogroup",
                title:"请选择中文意思",
                name: "アナロジー",
                choices: [
                    "无法用语言表达的感情", "自我牺牲的爱", "把相反的两个事物当作一个整体来看的方法", "通过类比成相似事物来进行的理解或说明", "我不知道这个词"
                ],
                correctAnswer: "通过类比成相似事物来进行的理解或说明"
            }
        ]
    },
    {
        ...
        {
            type:"html",
            html:"<audio src=\"3.mp3\" autoplay></audio><b><u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u>: あの人は<u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</u> が好きだ。。</b>",
        },
        {
            type: "radiogroup",
            title:"请选择中文意思",
            name: "パンケーキ",
            choices: [
                "用面粉、鸡蛋等制作烘培出来的食物", "德国的快车道", "1950年代在全世界流行的音乐", "无色而味重的饮料", "我不知道这个词"
            ],
            correctAnswer: "用面粉、鸡蛋等制作烘培出来的食物"
        }
    ]
    },
